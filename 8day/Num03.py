...
ar4 = np.array([[1,2,3],[4,5,6]],dtype=np.float64)
ar5 = np.array([[9,8,7],[6,5,4]],dtype=np.float64)
print(ar4+ar5)
print(ar4-ar5)
print(ar4*ar5)
print(ar4/ar5)
...
ar9 = np.array([[2,3],[4,5]])

print(ar8**ar9)
print(np.matmul(ar8,ar9)) # matrix nul
...
print(ar12)
print(np.matmul(ar12,ar11)) # matrix nul